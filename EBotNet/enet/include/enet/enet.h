...
enum
{
   ...
   ENET_PEER_DEFAULT_ROUND_TRIP_TIME      = 2000,
   ...
   ENET_PEER_TIMEOUT_MINIMUM              = 8000,
...
ENET_API void       enet_host_udp_tunnel (ENetHost *, const ENetAddress *); // SOCKS5 UDP associate tunnel for ENet
